...
if __name__ == "__main__":
    ...
    inp_folder=join(curr_folder,'relabeled_shortened_data_'+str(n)+'_subset_'+str(k))
    out_file=join(curr_folder,'relabeled_shortened_combined_'+str(n)+'_subset_'+str(k)+'.nex')
